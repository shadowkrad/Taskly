      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="card-taaaac bg-white border-amber-200/80">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">In Attesa</span>
          ...
          <div className="mt-2 flex items-baseline gap-2">
            ...
            <span className="text-xs text-amber-600 font-semibold">Da pianificare</span>
          </div>
        </div>

        <div className="card-taaaac bg-white border-indigo-200/80">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Pianificati</span>
          ...
          <div className="mt-2 flex items-baseline gap-2">
            ...
            <span className="text-xs text-indigo-600 font-semibold">In agenda</span>
          </div>
        </div>

        <div className="card-taaaac bg-white border-sky-200/80">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">In Corso</span>
          ...
          <div className="mt-2 flex items-baseline gap-2">
            ...
            <span className="text-xs text-sky-600 font-semibold">Sul posto</span>
          </div>
        </div>

        <div className="card-taaaac bg-white border-emerald-200/80">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Incasso Rapportini</span>
          ...
          <div className="mt-2 flex items-baseline gap-2">
            ...
            <span className="text-xs text-slate-500 font-medium">({completedCount} chiusi)</span>
          </div>
        </div>
      </div>
                  ...
                  <div className="space-y-2 flex-1">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {item.urgency === 'EMERGENZA' && (
                        <span className="px-2.5 py-0.5 rounded-full text-[10px] font-extrabold tracking-wide bg-rose-100 text-rose-800 border border-rose-200 flex items-center gap-1 animate-pulse">
